vector_main MATLAB Python Package
...
2. Installing the vector_main Package

A. Change to the directory that contains the file setup.py and the subdirectory 
vector_main. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the vector_main Package

The vector_main package is on your Python path. To import it into a Python script or 
session, execute:
